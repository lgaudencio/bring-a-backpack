...
from .views import AddPhotography, PhotographyList, PhotographyDetail, DeletePhotography, EditPhotography
...
urlpatterns = [
    ...
    path('edit/<slug:pk>/', EditPhotography.as_view(), name='edit_photography'), 
]